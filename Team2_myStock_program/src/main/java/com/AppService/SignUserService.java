...
import com.Exception.SignUserException;
import com.model.SignUserDTO;
import com.userService.UserDAO;
...
public class SignUserService {
	...
	SignUserException ne = new SignUserException();
	...
	public void selectAll() {
		...
		List<SignUserDTO> lists = dao.getList();

		Iterator<SignUserDTO> it = lists.iterator();

		int i = 1;

		while (it.hasNext()) {

			SignUserDTO dto = it.next();
	...
	public void searchId() {
		...
		List<SignUserDTO> lists = dao.getList(sc.next());
		Iterator<SignUserDTO> it = lists.iterator();
